...
bench: isbench ipbench lsbench lpbench fsbench fpbench dsbench dpbench 
...
simd_eg.o: simd_eg.c
	$(CC) $(CFLAGS) -O$(OPTLEVEL) -DSUM -DLONG -c simd_eg.c

combine.o: combine.c combine.h
	$(CC) $(CFLAGS) -O$(OPTLEVEL) -DSUM -DLONG -c combine.c
